...
import com.company.ems.security.TokenAuthenticationFilter;
 ...
 * - Stateless (no sessions) — uses Bearer tokens
 * - CORS enabled for React frontend on port 3000
 * - Login endpoint is public; all other /api/** require authentication
 */
@Configuration
@EnableWebSecurity
